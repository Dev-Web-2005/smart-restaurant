...
\hline
Các service hỗ trợ & Các service hỗ trợ được deploy riêng và tích hợp sử dụng & Lê Thành Công \\
\hline
...
\begin{itemize}
    ...
    \item Thiết kế các service hỗ trợ bên ngoài (mail service, payment service ...)
    \item ...
